...
# Make table with total interactions for Figures 7A, S6E, S9A, S10A
...
# To make Figures 7A, S6E, S9A, S10A
...
# Get table with total interaction strength for Figures 7B, S6F, S9B, S10B
...
# Make barplot of data for Figures 7C, 8A, S6G, S9C, S10C, S11A, S12A, S13A
...
# Make chord plots for Figures 7D,F,H; 8B,D,F; S6H; S9D,F; S10D,F; S11B,D; S12B,D; S13C
...
# Make heatmap of network centrality scores for Figures 7E,G,I; 8C,E,G; S6I; S9E,G; S10E,G; 
# S11C,E; S12C,E; S13B
...
# non-necrotic niches. Figures 7J-L; 8H-J; S6J; S9H-I; S10H-I; S11F-G; S12F-G; S13D
