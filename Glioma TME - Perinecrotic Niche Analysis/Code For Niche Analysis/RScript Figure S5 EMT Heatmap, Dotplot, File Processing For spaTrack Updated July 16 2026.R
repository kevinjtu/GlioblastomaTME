...
## Work in R using UCell to determine EMT scores to make Figure S5A ##
...
# Make heatmap for Figure 8A, done for each Xenium sample
...
# Make dotplot for Figure 8A, goes below heatmap, make for each Xenium sample
ls() ## list objects currently present in workspace
rm(list=ls()) ## remove objects from current workspace
ls() ## confirm current workspace is empty
