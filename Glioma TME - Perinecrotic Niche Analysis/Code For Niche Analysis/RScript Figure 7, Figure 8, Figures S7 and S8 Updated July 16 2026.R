...
# Make table with total interactions for Figures 7A, S7A
...
# Get table with total interaction strength for Figures 7B, S7B
...
# Make barplot of data for Figures 7C, 8A, S7C, S8A
...
# Make chord plots for Figures 7D,F,H; 8B,D,F
...
# Make heatmap of network centrality scores for Figures 7E,G,I; 8C,E,G; S7D; S8B;
# S11C,E; S12C,E; S13B
...
# non-necrotic niches. Figures 7J-L; 8H-J; S6J; S7E-I; S8C-G; S11F-G;
