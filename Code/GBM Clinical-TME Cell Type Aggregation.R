...
tcga_immune <- read_xlsx("TCGA RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
tempus_immune <- read_xlsx("TEMPUS RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Sample GSEA")
tempus_gsea <- read_xlsx("TEMPUS_GSEA.xlsx", sheet = 1)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
wu_immune <- read_xlsx("Wu2020 RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
cgga_immune <- read_xlsx("CGGA RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
cgga_b_immune <- read_xlsx("CGGA Batch 1 RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
gsam_immune <- read_xlsx("GSAM RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
ivygap_immune <- read_xlsx("IVYGAP RNAseq InstaPrism results.xlsx", sheet = 3)
...
glass_patient <- glass_patient %>%
  ...
  setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
glass_immune <- read_xlsx("GLASS RNAseq InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("TCGA Microarray InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Rembrandt Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Gravendeel Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("LeeY Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Phillips Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Freije Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Murat Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Joo Microarray InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
microarray_immune <- read_xlsx("Ducray Microarray InstaPrism results.xlsx", sheet = 3)
colnames(microarray_immune)[1] <- "patient_id"
...
Rembrandt_merged_clean  <- clean_all(Rembrandt_merged,  "Rembrandt")
Gravendeel_merged_clean  <- clean_all(Gravendeel_merged,  "Gravendeel")
LeeY_merged_clean  <- clean_all(LeeY_merged,  "LeeY")
Phillips_merged_clean  <- clean_all(Phillips_merged,  "Phillips")
Freije_merged_clean  <- clean_all(Freije_merged,  "Freije")
Murat_merged_clean  <- clean_all(Murat_merged,  "Murat")
Joo_merged_clean  <- clean_all(Joo_merged,  "Joo")
Ducray_merged_clean  <- clean_all(Ducray_merged,  "Ducray")
...
combined_dataset <- bind_rows(
  ...
  Rembrandt_merged_clean,
  Gravendeel_merged_clean,
  LeeY_merged_clean,
  Phillips_merged_clean,
  Freije_merged_clean,
  Murat_merged_clean,
  Joo_merged_clean,
  Ducray_merged_clean
...
table(Rembrandt_merged$treatment)
table(Gravendeel_merged$treatment)
table(LeeY_merged$treatment)
table(Phillips_merged$treatment)
table(Freije_merged$treatment)
table(Murat_merged$treatment)
table(Joo_merged$treatment)
table(Ducray_merged$treatment)
...
combined_summed <- combined_dataset %>% 
...
write.csv(combined_summed, "GBM Clinical-TME Cell Types.csv", row.names = FALSE)
...
setwd("~/Library/CloudStorage/OneDrive-Personal/Research/Duke Amgen/Glioblastoma TME/Instaprism Results")
cloughesy_immune <- read_xlsx("Cloughesy RNAseq InstaPrism results.xlsx", sheet = 3)
